		...
		for (const task of tasks) {
			...
			if (!bUpdating) {
				...
				if (oldTask) {
					...
					// vault file -- Project is TickTick metadata only here, and
					// this fork doesn't move/materialize notes based on it (see
					// ProjectSyncService's doc comment). Just update fields
					// (including parentId) in place.
